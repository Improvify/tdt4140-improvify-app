...
public class WorkoutplanToMarkdownConverter {
    ...
    public String createMarkdownString(WorkoutPlan workoutplanToConvert) {
        ...
        User user = workoutplanToConvert.getCreatedForUser();

        markdown.append("Created for " + user.getFirstName() + " " + user.getLastName() + "\n");
        markdown.append(workoutplanToConvert.getDescription() + "\n");
